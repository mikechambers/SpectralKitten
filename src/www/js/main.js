...
require(["libs/jquery.min", "js/FileSystemManager.js", "js/SpectralKitten.js", "libs/domReady.min",
		"js/libs/bootstrap.min.js", "js/libs/bootstrap-list.js", "js/Settings.js", "libs/handlebars"],
		function(_$, FileManager, SpectralKitten, domReady) {
			
			$ = window.$;
			SpectralKitten = window.SpectralKitten;
